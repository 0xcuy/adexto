 ...
 * chain "Live"; /governance dulu menampilkan tiga proposal yang `proposalCount`
 * on-chain-nya nol (rutenya sudah dicabut sepenuhnya); /agent/demo menampilkan
 * objek attestation yang ditulis tangan di dalam komponen.
 *
