...
export default function VerifiedDeploymentCard() {
  ...
  const records = [
    ...
    {
      label: "The Graph Subgraph (Decentralized Indexer v1.0.0)",
      address: GRAPH_STUDIO_CONFIG.httpEndpoint,
      explorerUrl: GRAPH_STUDIO_CONFIG.dashboardUrl,
      badge: "The Graph Studio Live",
