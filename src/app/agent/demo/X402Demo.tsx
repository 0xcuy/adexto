 ...
 *
 * Dan pasarnya sekarang DITERIMA sebagai prop, bukan dipaku di berkas ini. Nilainya dulu
 * `"adexto"`, yang membuat setiap pengunjung menyimpulkan gerbangnya cuma melayani satu
 * token — padahal setiap pasar hidup punya endpoint sendiri. Lebih buruk lagi, ticker
 * yang dipaku bisa mati: listing bisa dicabut, dan $CURB sudah dicabut, jadi halaman ini
 * akan mendemokan alamat yang menjawab `unknown_market`. `page.tsx` memilihnya dari
 * registry di server supaya aturan pemilihannya hanya ada di satu tempat.
 */
